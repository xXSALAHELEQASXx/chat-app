...
const Sidebar = () => {
    ...
    // AI User object
    const AI_USER = { _id: "AI", fullName: "AI Assistant", profilePic: null };
  ...
  return (
    ...
    <div className='flex flex-col gap-2'>
        {/* --- AI Assistant Chat --- */}
        <div onClick={()=> {setSelectedUser(AI_USER); setUnseenMessages(prev=> ({...prev, [AI_USER._id]:0}))}}
             className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id === AI_USER._id && 'bg-[#282142]/50'}`}>
            <img src={assets.profile_martin} alt="" className='w-[35px] aspect-[1/1] rounded-full'/>
            <div className='flex flex-col leading-5'>
                <p>{AI_USER.fullName}</p>
